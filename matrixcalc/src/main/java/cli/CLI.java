    ...
    public void parse(String line) {
        try {
            ...
            if (parts[0].equals("ls")) {
                ...
                if (parts[2].equals("add") && parts.length > 4) {
                    if (realMatrices.containsKey(parts[3])) {
                        if (realMatrices.containsKey(parts[4])) {
                            RealMatrix temp = realMatrices.get(parts[3]).add(realMatrices.get(parts[4]));
                            realMatrices.put(parts[0], temp);
                            System.out.println(parts[0] + " = ");
                            System.out.println(temp);
                        } else {
                            System.out.println("Matrix " + parts[4] + " not loaded yet.");
                        }
                    } else if (complexMatrices.containsKey(parts[3])) {
                        if (complexMatrices.containsKey(parts[4])) {
                            ComplexMatrix temp = complexMatrices.get(parts[3]).add(complexMatrices.get(parts[4]));
                            complexMatrices.put(parts[0], temp);
                            System.out.println(parts[0] + " = ");
                            System.out.println(temp);
                        } else {
                            System.out.println("Matrix " + parts[4] + " not loaded yet.");
                        ...
                        System.out.println("Matrix " + parts[3] + " not loaded yet.");
                    }
                } else if (parts[2].equals("subtract") && parts.length > 4) {
                    if (realMatrices.containsKey(parts[3])) {
                        if (realMatrices.containsKey(parts[4])) {
                            RealMatrix temp = realMatrices.get(parts[3]).subtract(realMatrices.get(parts[4]));
                            realMatrices.put(parts[0], temp);
                            System.out.println(parts[0] + " = ");
                            System.out.println(temp);
                        } else {
                        ...
                        if (complexMatrices.containsKey(parts[4])) {
                            ComplexMatrix temp = complexMatrices.get(parts[3]).subtract(complexMatrices.get(parts[4]));
                            complexMatrices.put(parts[0], temp);
                            System.out.println(parts[0] + " = ");
                            System.out.println(temp);
                        } else {
                ...
                } else if (parts[2].equals("multiply") && parts.length > 4) {
                    if (realMatrices.containsKey(parts[3])) {
                        if (realMatrices.containsKey(parts[4])) {
                            RealMatrix temp = realMatrices.get(parts[3]).multiply(realMatrices.get(parts[4]));
                            realMatrices.put(parts[0], temp);
                            System.out.println(parts[0] + " = ");
                            System.out.println(temp);
                        } else {
                        ...
                        if (complexMatrices.containsKey(parts[4])) {
                            ComplexMatrix temp = complexMatrices.get(parts[3]).multiply(complexMatrices.get(parts[4]));
                            complexMatrices.put(parts[0], temp);
                            System.out.println(parts[0] + " = ");
                            System.out.println(temp);
                        } else {
                ...
                } else if (parts[2].equals("mpower") && parts.length > 4) {
                    if (realMatrices.containsKey(parts[3])) {
                        if (parts[4].matches("-?\\d+(\\.\\d+)?")) {
                            RealMatrix power = realMatrices.get(parts[3]);
                            RealMatrix temp = new RealMatrix(power.getArray());
                            for (int i = 1; i < Integer.valueOf(parts[4]); i++) {
                                temp = temp.multiply(temp);
                            }
                            realMatrices.put(parts[0], temp);
                            System.out.println(parts[0] + " = ");
                            ...
                            System.out.println(parts[4] + " is not a number.");
                        }
                    } else if (complexMatrices.containsKey(parts[3])) {
                        if (parts[2].matches("-?\\d+(\\.\\d+)?")) {
                            ComplexMatrix power = complexMatrices.get(parts[3]);
                            ComplexMatrix temp = new ComplexMatrix(power.getArray());
                            for (int i = 1; i < Integer.valueOf(parts[4]); i++) {
                                temp = temp.multiply(temp);
                            }
                ...
                } else if (parts[2].equals("smultiply") && parts.length > 4) {
                    if (realMatrices.containsKey(parts[3])) {
                        if (parts[4].matches("-?\\d+(\\.\\d+)?")) {
                            RealMatrix temp = realMatrices.get(parts[3]).multiply(Double.valueOf(parts[4]));
                            realMatrices.put(parts[0], temp);
                            System.out.println(parts[0] + " = ");
                            System.out.println(temp);
                        } else {
                        ...
                        if (parts[4].matches("-?\\d+(\\.\\d+)?")) {
                            ComplexMatrix temp = complexMatrices.get(parts[3]).multiply(Double.valueOf(parts[4]));
                            complexMatrices.put(parts[0], temp);
                            System.out.println(parts[0] + " = ");
                            System.out.println(temp);
                        } else {
                ...
                } else if (parts[2].equals("transpose") && parts.length > 3) {
                    if (realMatrices.containsKey(parts[3])) {
                        RealMatrix temp = realMatrices.get(parts[3]).transpose();
                        realMatrices.put(parts[0], temp);
                        System.out.println(parts[0] + " = ");
                        System.out.println(temp);
                    } else if (complexMatrices.containsKey(parts[3])) {
                        ComplexMatrix temp = complexMatrices.get(parts[3]).transpose();
                        complexMatrices.put(parts[0], temp);
                        System.out.println(parts[0] + " = ");
                        System.out.println(temp);
                    } else {
                ...
                } else if (parts[2].equals("invert") && parts.length > 3) {
                    if (realMatrices.containsKey(parts[3])) {
                        RealMatrix temp = realMatrices.get(parts[3]).inverse();
                        realMatrices.put(parts[0], temp);
                        System.out.println(parts[0] + " = ");
                        System.out.println(temp);
                    } else if (complexMatrices.containsKey(parts[3])) {
                        ComplexMatrix temp = complexMatrices.get(parts[3]).inverse();
                        complexMatrices.put(parts[0], temp);
                        System.out.println(parts[0] + " = ");
                        System.out.println(temp);
                    } else {
                ...
                System.out.println("[matrix] = [command]" + "\t" + "- creates matrix determined by command");
                System.out.println("help" + "\t" + "- displays this help text");
                System.out.println("exit" + "\t" + "- exits the program");
            } else if (parts[0].equals("exit")) {
                active = false;
            } else if (realMatrices.containsKey(parts[0])) {
                System.out.println(parts[0] + " = ");
                System.out.println(realMatrices.get(parts[0]));
            } else if (complexMatrices.containsKey(parts[0])) {
                System.out.println(parts[0] + " = ");
                System.out.println(complexMatrices.get(parts[0]));
            } else {
                System.out.println("???");
            }
