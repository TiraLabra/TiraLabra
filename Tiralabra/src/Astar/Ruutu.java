...
/**
 * A*-algoritmin labyrintti muodostuu ruuduista. Luokka 'Ruutu' pitää sisällään
 * kaikki yhden labyrintilla sijaitsevan ruudun ominaisuudet.
 *
...
public class Ruutu {
     ...
     *
     * Luokassa Ruutu kaytetään yllä olevan tutoriaalin mukaisia muuttujia f, g
     * ja h.
     *
     * g = etäisyys alkuun h = arvioitu etäisyys maaliin
     */
    // A*-F-arvo
    private int f;
    // A*-G-arvo
    ...
    /**
     * Konstruktori, jossa asetetaan ruudulle tiedot sen vanhemmasta, y- ja
     * x-akselin arvoista, g- ja h-arvoista, sekä lasketaan f-arvo edellisten
     * avulla.
     *
    ...
    /**
     * Metodi vertailee parametrina saadun ruudun f-arvoa ko. olion f-arvoon.
     *
