/**
 * Laskin toteuttaa liukulukutaulukkona annetuille matriiseille laskutoimituksia.
 * 
...
public class Laskin {
     ...
     * 
     * @param matriisi Liukulukutaulukkona annetaan matriisi, joka kerrotaan skalaarilla
     ...
     * @throws Exception Vain samanmuotoiset matriisit voidaan laskea yhteen 
     * ja mikäli tyyppi ei täsmää, metodi palauttaa poikkeuksen.
     */
    ...
    /**
     * Matriisin 1 sarakkeiden määrän täytyy olla sama kuin matriisin 2 vaakarivien määrä. 
     * Muussa tapauksessa laskutoimitus ei ole määritelty.
     * 
     * @param matriisi1 Kertoja matriisi.
     * @param matriisi2 Kerrottava matriisi.
     * @return Matriisien tulo.
     * @throws Exception Metodi palauttaa poikkeuksen jos matriisien tuloa ei ole määritelty.
     */
 ...
 */    
    public double[][] luDekompositioDoolittleYlempiKolmiomatriisi(double[][] matriisi) {
 ...
 */ 
    ...
    public double[][] luDekompositioDoolittle(double[][] matriisi) {
...
//    private double determinantti2x2(double[][] matriisi) {
//        return matriisi[0][0] * matriisi[1][1] - matriisi[1][0] * matriisi[0][1];
//    }

    
//    private int determinantti3x3(double[][] matriisi) throws Exception {
//
//        // Sarrusin sääntö.
//
//        if (matriisi.length == 3) {
//            int nousevat = 0;
//            int laskevat = 0;
//
//            laskevat += matriisi[0][0] * matriisi[1][1] * matriisi[2][2];
//            laskevat += matriisi[0][1] * matriisi[1][2] * matriisi[2][0];
//            laskevat += matriisi[0][2] * matriisi[1][0] * matriisi[2][1];
//
//            nousevat += matriisi[2][0] * matriisi[1][1] * matriisi[0][2];
//            nousevat += matriisi[2][1] * matriisi[1][2] * matriisi[0][0];
//            nousevat += matriisi[2][2] * matriisi[1][0] * matriisi[0][1];
//
//            return laskevat - nousevat;
//        } else {
//            throw new Exception("Matriisi ei ole 3x3 matriisi");
//        }
//    }
}
