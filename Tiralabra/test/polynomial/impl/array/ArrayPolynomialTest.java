...
public class ArrayPolynomialTest {
    ...
    public void testAddWithDifferentCharacteristic() {
        ...
        ArrayPolynomial polynomial2 = new ArrayPolynomial(characteristic2);
        polynomial.addTerm(1, 3);
    ...
    public void testAddZeroPolynomial() {
        ...
        ArrayPolynomial polynomial2 = new ArrayPolynomial(characteristic);
    ...
    public void testDivideZeroPolynomial() {
        ...
        ArrayPolynomial divisor = new ArrayPolynomial(characteristic);
