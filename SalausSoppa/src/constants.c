...
uint8_t sboxes[8][4][16] = {SBOX_1, SBOX_2, SBOX_3, SBOX_4,
                            SBOX_5, SBOX_6, SBOX_7, SBOX_8};

uint8_t sbox_1[4][16] = SBOX_1;
uint8_t sbox_2[4][16] = SBOX_2;
uint8_t sbox_3[4][16] = SBOX_3;
uint8_t sbox_4[4][16] = SBOX_4;
uint8_t sbox_5[4][16] = SBOX_5;
uint8_t sbox_6[4][16] = SBOX_6;
