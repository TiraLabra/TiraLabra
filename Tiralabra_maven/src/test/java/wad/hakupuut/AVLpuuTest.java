...
public class AVLpuuTest {
    ...
    public void monenLisays() {
        ...
        assertEquals("7{3{1{0,2},5{4,6}},9{8,10{[],11}}}", avl.tulosta(avl.getJuuri()));
    }
    ...
    public void lehdenPoistoIlmanKiertoa() {
        ...
        assertEquals("4{2{1,3},8{6{5,7},10{9,11}}}", avl.tulosta(avl.getJuuri()));
    }
    ...
    public void lehdenPoistoOikeaKierto() {
        ...
        assertEquals("4{1{0,2},8{6{5,7},10{9,11}}}", avl.tulosta(avl.getJuuri()));
    }
    ...
    public void kaksilapsisenPoistoOikeaKierto() {
        ...
        assertEquals("4{1{0,3},8{6{5,7},10{9,11}}}", avl.tulosta(avl.getJuuri()));
    }
    ...
    public void juurenPoisto() {
        ...
        assertEquals("5{2{1{0,[]},3},8{6{[],7},10{9,11}}}", avl.tulosta(avl.getJuuri()));
    }
    ...
    public void vasenKaantoKunPoistetaan() {
        ...
        avl.poista(1);
        assertEquals("3{2,4}",avl.tulosta(avl.getJuuri()));
    }
    ...
    public void oikeaKaantoKunPoistetaan() {
        ...
        avl.poista(4);
        assertEquals("2{1,3}",avl.tulosta(avl.getJuuri()));
    }
