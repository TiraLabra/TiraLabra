...
/**
 * Rajapinta pinolle. Pinon alkiot tyyppiä Paikka. Tätä rajapintaa käyttämällä
 * koodia ei tarvitse muuttaa kun siirrytään Javan Stack:in käyttämisestä pinon
 * oman toteutuksen käyttämiseen.
 */
