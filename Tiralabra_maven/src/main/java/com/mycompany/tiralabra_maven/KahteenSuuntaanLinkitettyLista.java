...
/**
 * Luokka kuvaa kahteen suuntaan linkitettyä listaa.
 * Listaan voi lisätä solmuja ja siitä voi poistaa solmuja. 
 * Listalta voi myös etsiä tietyn avaimen sisältävää solmua.
 * 
 * @author sampox
 */
 ...
 * 
 *
 * @param   avain   Uuden solmun avain
 ...
 *
 * @param   poistettavaSolmu   Listalta poistettava solmu
 * 
 */
    public void poistaSolmu(Solmu poistettavaSolmu) {
        ...
        else{this.ensimmainenSolmu=poistettavaaSeuraava;}
 ...
 * annettu avain.
 *
 * @param   avain   Linkitetystä listasta etsittävä avain
 * 
 ...
 */
    public Solmu etsiAvainListalta(String avain) {
        ...
        while (EtsittavanAvaimenSolmu!=null && !avain.equals(EtsittavanAvaimenSolmu.getAvain())) {
