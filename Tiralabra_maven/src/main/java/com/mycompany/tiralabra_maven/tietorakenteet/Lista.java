...
public class Lista<E> {
    ...
    /**
     * Konstruktorissa luodaan uusi taulukko, johon alkioita voi sitten
     * tallettaa. Taulukko on aluksi tyhjä ja sen pituus on määritelty.
     */
    public Lista() {
    ...
    /**
     * Konstruktori, jolle voi antaa vertailijan, jonka avulla voidaan vertailla
     * sellaisia objekteja, joiden luonnollinen vertailu ei onnistu.
     *
    ...
    /**
     * Metodin avulla lisätään annettu objekti listaan. Jos taulukko tulee
     * täyteen, sitä kasvatetaan.
     *
    ...
    /**
     * Palauttaa Listan suurimman alkion. Vertailu tehdään tarvittaessa
     * vertailijan avulla. Jos suurimpia alkioita on useampia, niistä palautetaan yksi
     *
     ...
     */
    public E getAlkio(int paikka) {
        return (E) this.taulukko[paikka];
    }
