 ...
 * @author E
 */
public class AStarOmallaTietorakenteella {
     ...
     */
    private ReittiLaskinOmallaTietorakenteella laskin;
     ...
     * @param laskin
     */
    public AStarOmallaTietorakenteella(VerkkoOmallaTietorakenteella verkko, ReittiLaskinOmallaTietorakenteella laskin) {
        this.verkko = verkko;
        this.laskin = laskin;
     ...
     */
    public AStarOmallaTietorakenteella(VerkkoOmallaTietorakenteella verkko) {
        this(verkko, new ReittiLaskinOmallaTietorakenteella());
    }

    /**
     * Oletuskonstruktori
     */
    public AStarOmallaTietorakenteella() {
        this(new VerkkoOmallaTietorakenteella(), new ReittiLaskinOmallaTietorakenteella());
    }
    ...
    public Reitti etsiReitti(Pysakki alku, Pysakki maali ) {
        ...
        Lista<Reitti> parhaatReitit = new DynaaminenLista();
     ...
     * toString
     */
    private DynaaminenLista<String> kasitellytKaaret = new DynaaminenLista();
    /**
     * Taulussa pysäkki ja pienin kustannus jolla sinne päästään
     */
    private Hajautustaulu<Pysakki, Double> nopeimmatSiirtymatPysakille = new Hajautustaulu();
    /**
     ...
     * @return
     */
    private String debugRatkaisu(Lista<Reitti> parhaatReitit) {
