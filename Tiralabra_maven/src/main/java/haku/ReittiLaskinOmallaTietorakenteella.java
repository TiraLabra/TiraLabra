 ...
 * @author E
 */
public class ReittiLaskinOmallaTietorakenteella {
    /**
     ...
     * positiivisia
     */
    public ReittiLaskinOmallaTietorakenteella(double aikaPaino, double matkaPaino, double vaihtoPaino, double heurAikaPaino, double heurMatkaPaino, double heurKulkunopeus) {
     ...
     */
    public ReittiLaskinOmallaTietorakenteella() {
        // this(1,0,0,0,0,400);
        this.aikaPaino = 1;
        this.matkaPaino = 0;
    ...
    public VerkkoOmallaTietorakenteella getVerkko() {
        return verkko;
    }

    public void setVerkko(VerkkoOmallaTietorakenteella verkko) {
        this.verkko = verkko;
    }
